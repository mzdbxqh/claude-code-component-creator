...
### 调用示例
```
用户: /cmd-implement --plan=docs/designs/my-refactor.md
  ↓
...
/cmd-implement --plan=docs/designs/my-refactor.md

# Implement specific phase
/cmd-implement --plan=docs/designs/my-refactor.md --phase=1

# Dry run (preview changes)
/cmd-implement --plan=docs/designs/my-refactor.md --dry-run
```
