...
[![Quality Score](https://img.shields.io/badge/quality-{quality_score}%2F100-brightgreen.svg)](docs/reviews/)
...
CCC achieves **{quality_score}/100** overall quality score with comprehensive 8-dimension checks:
...
Copyright (c) {current_year} showme.cc
...
**Version**: {version} | **Quality Score**: {quality_score}/100 | **License**: {license}
